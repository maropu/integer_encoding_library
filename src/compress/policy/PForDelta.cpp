...
static inline void __p4delta_unpack0(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack1(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack2(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack3(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack4(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack5(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack6(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack7(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack8(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack9(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack10(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack11(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack12(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack13(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack16(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack20(uint32_t *out, uint32_t *in);
static inline void __p4delta_unpack32(uint32_t *out, uint32_t *in);
...
uint32_t
PForDelta::tryB(uint32_t b, uint32_t *in, uint32_t len) const
{
        __assert(b <= 32);
        __assert(in != NULL);
        __assert(len != 0 && len <= MAXLEN);
...
uint32_t
PForDelta::findBestB(uint32_t *in, uint32_t len) const
{
        __assert(in != NULL);
        __assert(len != 0 && len <= MAXLEN);
                ...
                uint32_t *out, uint32_t &nvalue) const
{
        ...
        if (b < 32) {
                ...
                if (curExcept > 0) {
                        ...
                        s16.encodeArray(exceptions, 2 * curExcept,
